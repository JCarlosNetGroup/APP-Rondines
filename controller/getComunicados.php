...
try {
    ...
    // Obtener comunicados paginados (incluyendo ruta_archivo)
    $sql = "SELECT id_comunicado, titulo, descripcion, fecha, ruta_archivo FROM comunicados ORDER BY fecha DESC LIMIT :perPage OFFSET :offset";
